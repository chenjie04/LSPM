...
def main():
    ...
    run_dir = "./run/GMF_taobao/{}".format(config['timestamp'])
    ...
    valid_results_file = os.path.join(run_dir, 'GMF_taobao_valid_results.csv')
    ...
    for epoch in range(args.epochs):
        ...
        for batch_index, (user, item, _, label) in enumerate(loader):
        ...
        mlperf_log.ncf_print(key=mlperf_log.EVAL_TARGET)
